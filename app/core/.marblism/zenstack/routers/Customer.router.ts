...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.CustomerInputSchema.createMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).customer.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.CustomerInputSchema.deleteMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).customer.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.CustomerInputSchema.findFirst.optional()).query(({ ctx, input }) => checkRead(db(ctx).customer.findFirst(input as any))),

        findMany: procedure.input($Schema.CustomerInputSchema.findMany.optional()).query(({ ctx, input }) => checkRead(db(ctx).customer.findMany(input as any))),
        ...
        count: procedure.input($Schema.CustomerInputSchema.count.optional()).query(({ ctx, input }) => checkRead(db(ctx).customer.count(input as any))),
...
export interface ClientType<AppRouter extends AnyRouter, Context = AppRouter['_def']['_config']['$types']['ctx']> {
    ...
    count: {
        ...
        useQuery: <T extends Prisma.CustomerCountArgs, TData = 'select' extends keyof T
            ? T['select'] extends true
            ? number
            : Prisma.GetScalarType<T['select'], Prisma.CustomerCountAggregateOutputType>
            : number>(
                input?: Prisma.Subset<T, Prisma.CustomerCountArgs>,
                ...
                TRPCClientErrorLike<AppRouter>
            >;
        useInfiniteQuery: <T extends Prisma.CustomerCountArgs>(
            input?: Omit<Prisma.Subset<T, Prisma.CustomerCountArgs>, 'cursor'>,
